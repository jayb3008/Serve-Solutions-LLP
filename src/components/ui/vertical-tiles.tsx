...
export function VerticalTilesLoader() {
  return (
    <div className="fixed inset-0 z-[9999] bg-background">
      <VerticalTiles
        containerClassName="h-full min-h-screen"
        tileClassName="bg-gray-800/90 dark:bg-gray-200/90"
        animationDuration={0.6}
        animationDelay={0}
        stagger={0.04}
      >
        <div className="absolute inset-0 grid place-items-center">
          <span className="text-white/80 dark:text-black/70 text-base tracking-wide">
            Loading…
          </span>
        </div>
      </VerticalTiles>
