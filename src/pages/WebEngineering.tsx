...
const process = [
  {
    n: "01",
    title: "Architecture",
    body: "We define the stack, data models, caching strategy, and deploy target before writing production code. No surprises at launch.",
  },
  {
    n: "02",
    title: "Build",
    body: "Two-week sprints with CI/CD from day one. Every PR is reviewed, tested, and deployed to a preview environment.",
  },
  {
    n: "03",
    title: "QA",
    body: "Automated E2E tests, performance audits, and accessibility checks run on every deploy. We catch regressions before your users do.",
  },
  {
    n: "04",
    title: "Launch",
    body: "Zero-downtime deploy, real-time error monitoring, and a full handover — documentation, runbooks, and on-call support included.",
  },
];
        ...
        <div className="wrap relative z-10">
          ...
          <div className="page-hero__sub">
            <div className="breadcrumb">
              Satvix Tech Solutions &nbsp;/&nbsp; Services &nbsp;/&nbsp; Web
              Engineering
            </div>
            <p>
        ...
        <div className="marquee__track">
          {[0, 1].map((i) => (
            <span key={i} className="marquee__item">
              Next.js <span className="star">✦</span> React <em>·</em>{" "}
              TypeScript <span className="star">✦</span> Headless CMS <em>·</em>{" "}
              E-commerce <span className="star">✦</span> Performance{" "}
              <em>·</em>{" "}
            </span>
          ))}
        </div>
      ...
      <section className="s" style={{ padding: "120px 0" }}>
        <div className="wrap">
          <div className="s-head">
            ...
            >
              Technology-agnostic but opinionated — we default to tools that are
              fast, well-supported, and battle-tested at scale.
            </p>
          </div>
