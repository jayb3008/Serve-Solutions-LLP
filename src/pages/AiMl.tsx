...
const process = [
  { n: '01', title: 'Discovery & scoping', body: 'We map your data, users, and workflows to find where AI creates real leverage — not just novelty.' },
  { n: '02', title: 'Prototype & evaluate', body: 'Two-week spike: we build a working prototype, measure output quality, and stress-test edge cases before committing.' },
  { n: '03', title: 'Build & integrate', body: 'Production implementation wired into your product — with streaming, error handling, and cost guardrails built in.' },
  { n: '04', title: 'Monitor & improve', body: 'We instrument every AI call, track quality over time, and ship improvements as models and your data evolve.' },
];
        ...
        <div className="marquee__track">
          {[0, 1].map(i => (
            <span key={i} className="marquee__item">
              LLM integration <span className="star">✦</span> RAG pipelines <em>·</em> AI agents <span className="star">✦</span> Fine-tuning <em>·</em> Data pipelines <span className="star">✦</span> Evaluation <em>·</em>{' '}
            </span>
          ))}
        </div>
      </div>
