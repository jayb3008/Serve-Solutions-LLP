...
const models = [
  {
    ...
    points: [
      ...
      "You set the roadmap, we set the standard",
    ],
  },
  {
    ...
    points: [
      "Individual experts, by the month",
  ...
  },
  {
    ...
    points: [
      ...
      "Clean handover on day one of week N",
    ],
  },
];
...
const roles = [
  ...
  },
  {
    icon: ShieldCheck,
    title: "QA engineers",
    stack: "Playwright · Cypress · Automation",
  },
];
...
const steps = [
  {
    ...
    desc: "Two paragraphs is plenty: the roles, the rough skills, the date. You will hear back from a real person, usually same day.",
  },
  {
    n: "02",
    title: "Meet a small shortlist",
    desc: "Three people, not thirty. People we would put on our own projects. You interview them; you decide.",
  },
  {
    n: "03",
    title: "Start inside a fortnight",
    desc: "Most engagements begin within five to ten working days, with a fortnight to confirm fit before anything is locked in.",
  },
  {
    n: "04",
    title: "Grow, shrink, rotate",
    desc: "As the roadmap changes, the team changes with it — without losing the context the original team built up.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Five to ten working days, usually. Send the brief, hear back within twenty-four hours, see a shortlist within forty-eight, interview, onboard.",
  },
  {
    question: "Do I interview the people you propose?",
    answer:
      "Always. We only put forward people we would happily put on our own projects, and you decide whether they join yours.",
  },
  {
    question: "What time zones do you cover?",
    answer:
      "We are in Anand, Gujarat — IST. We guarantee at least four hours of real overlap with India, Europe, the UK, the Middle East, and most US time zones (including the US east-coast morning).",
  },
  {
    question: "Is there a long contract?",
    answer:
      "No. Dedicated and embedded engagements are month-by-month. You can scale up or down with reasonable notice; we have never asked for a multi-year lock-in.",
  },
  {
    question: "What if someone is the wrong fit?",
    answer:
      "Two-week trial on every engagement. If it is not working, we swap people quickly, without charging you for the cross-over.",
  },
];
