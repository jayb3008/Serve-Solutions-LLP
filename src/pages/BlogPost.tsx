      ...
      <article>
        ...
        >
          ...
          <div className="wrap relative z-10" style={{ maxWidth: 900 }}>
            ...
            <h1
              style={{ fontSize: "clamp(34px, 6vw, 76px)", maxWidth: "20ch" }}
            >
              <motion.span
                initial={{ y: "110%" }}
                animate={{ y: 0 }}
              ...
              if (block.type === "list")
                return (
                  <ul
                    key={i}
                    className="reveal"
                    style={{ margin: "20px 0", padding: 0, listStyle: "none" }}
                  >
            ...
            >
              ...
              <div>
                ...
                <div style={{ color: "var(--muted)", fontSize: 14 }}>
                  {post.role} at Satvix Tech Solutions
                </div>
              </div>
            </div>
          </div>
