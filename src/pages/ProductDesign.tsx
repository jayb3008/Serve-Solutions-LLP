...
const process = [
  { n: '01', title: 'Discovery', body: 'We map your users, jobs-to-be-done, and business goals before sketching a single screen. No assumptions — only evidence.' },
  { n: '02', title: 'Wireframes', body: 'Low-fidelity flows validated with real users. We find the holes before visual polish makes them expensive to fix.' },
  { n: '03', title: 'Visual design', body: 'Pixel-perfect UI built on a tokenised system — Figma components wired to production-ready design tokens.' },
  { n: '04', title: 'Handoff & QA', body: 'Annotated specs, dev-ready tokens, and design QA in staging. We stay in the room until the build matches the vision.' },
];
    ...
    <div>
      ...
      <section className="page-hero" ref={heroRef}>
        <div className="wrap">
          ...
          <h1>
            {(['Design that', 'people actually', '<em>want to use.</em>'] as const).map((line, i) => (
        ...
        <div className="marquee__track">
          {[0, 1].map(i => (
            <span key={i} className="marquee__item">
              UX research <span className="star">✦</span> Wireframes <em>·</em> Prototyping <span className="star">✦</span> UI design <em>·</em> Design systems <span className="star">✦</span> Handoff <em>·</em>{' '}
            </span>
          ))}
        </div>
      </div>
        ...
        <div className="wrap">
          <div className="s-head">
            ...
            <p className="reveal" data-d="2" style={{ maxWidth: '32ch', color: 'var(--ink-2)', fontSize: 16, lineHeight: 1.55, margin: 0 }}>
              We pick the right tool for each job — not the one we're most comfortable with.
            </p>
          </div>
