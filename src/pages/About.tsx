  ...
  const timeline = [
    {
      ...
      title: "Founded",
      description:
        "WebFlow Architects was established with a mission to create custom digital solutions.",
    },
    {
      year: "2016",
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0, x: (index) => (index % 2 === 0 ? -50 : 50) },
      {
        ...
        ease: "power3.out",
        scrollTrigger: {
          trigger: timelineRef.current[0].parentElement,
          start: "top 80%",
          toggleActions: "play none none none",
        },
      }
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div ref={heroRef} className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                WebFlow Architects is a team of dedicated professionals
                passionate about creating custom web and mobile applications
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Founded in 2014, WebFlow Architects has grown from a small
                  group of passionate developers to a full-service digital
                  agency with expertise across web development, mobile
        ...
        {/* Team */}
        <section className="py-20 bg-gray-50 dark:to-gray-900">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Meet Our Team
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-transform duration-300 group-hover:-translate-y-2">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-brand-blue dark:text-brand-teal">
                        {member.position}
                      </p>
                    </div>
                  </div>
